...
// 1. Adventurer
int adventurerCardEffect(int currentPlayer, struct gameState *state, int handPos){
    ...
    while(drawntreasure > 2){
        ...
        //draw card; top card of hand is most recently drawn card
...
// 5. Remodel
int remodelCardEffect(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2){
    int i;
    int j;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
        case adventurer:
            return adventurerCardEffect(currentPlayer, state, handPos);
        ...
        case remodel:
            return remodelCardEffect(currentPlayer, state, handPos, choice1, choice2);
            
        case smithy:
            return smithyCardEffect(currentPlayer, state, handPos);
            
        case village:
            return villageCardEffect(currentPlayer, state, handPos);
